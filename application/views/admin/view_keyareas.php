...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/keyarea/add" class="btn btn-primary btn-sm">Add New</a>
	</div>
</section>
							...
							foreach ($keyarea as $row) {
								...
								<tr>
									...
									<td style="width:250px;">
										<img class="bg-success" src="<?php echo base_url(); ?>public/uploads/<?php echo $row['photo']; ?>" alt="<?php echo $row['name']; ?>" style="width:150px;"></td>
									<td>
										<a class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModal<?php echo $i; ?>">Details</a>						
										<a href="<?php echo base_url(); ?>admin/keyarea/edit/<?php echo $row['id']; ?>" class="btn btn-primary btn-xs">Edit</a>
									</td>
								</tr>
